...
def generate_bet_builder(
    ...
    ALL_MARKETS = [
        ...
        ("draw", "Match nul", "Résultat", "draw", 0.30),
        ("dc_home", "1 ou N (Double chance)", "Double Chance", "dc_home", 0.55),
        ("dc_away", "N ou 2 (Double chance)", "Double Chance", "dc_away", 0.55),
        ("dc_12", "1 ou 2 (Pas de nul)", "Double Chance", "dc_12", 0.65),
        ("over_05", "Plus de 0.5 buts", "Buts", "over_05", 0.90),
        ("over_15", "Plus de 1.5 buts", "Buts", "over_15", 0.65),
        ("over_25", "Plus de 2.5 buts", "Buts", "over_25", 0.50),
        ("over_35", "Plus de 3.5 buts", "Buts", "over_35", 0.40),
        ("under_25", "Moins de 2.5 buts", "Buts", "under_25", 0.50),
        ("under_35", "Moins de 3.5 buts", "Buts", "under_35", 0.50),
        ...
        ("goals_2_3", "2 ou 3 buts dans le match", "Fourchette", "goals_2_3", 0.35),
